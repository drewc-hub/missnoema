...
export async function POST(req: Request) {
  ...
  if (
    ...
    return new Response(JSON.stringify({ error: "NSFW unlock required." }), { status: 403 });
  }
  ...
  if (
    ...
    return new Response(JSON.stringify({ error: "Premium companions pass required." }), { status: 403 });
  }
