...
export default async function CreatorPage() {
  ...
  const publicCount = companions.filter(
    (c) => c.visibility === Visibility.PUBLIC,
  ).length;
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400">
              Manage your companions as marketplace-ready inventory. Publishing
              still uses existing visibility and content rating controls.
            </p>
          </div>
          <a
            href="/companions/new"
      ...
      {companions.length > 0 ? (
              ...
              >
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-3 p-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <StatusPill tone={isAdult ? "adult" : "safe"}>
        ...
        <section className="rounded-lg border border-dashed border-zinc-800 bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.25),transparent_55%)]  p-8 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-zinc-400">
            Create your first companion, then use this studio to prepare it for
            discovery.
          </p>
          <a
            href="/companions/new"
