...
export default async function WorldStudioPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[1680px] space-y-5 text-zinc-100">
      <section>
        <div className="inline-flex items-center rounded-full border border-cyan-400/30 bg-cyan-500/10 px-3 py-1 text-xs font-semibold text-cyan-100">
          Dungeon creator
        </div>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-zinc-400">
          Build worlds, scenes, and SillyTavern V2-style character cards from
          one workspace.
        </p>
      </section>
        ...
        companions={companions.map((companion) => {
          ...
          return {
            ...
            profile: {
              ...
              scenario:
                companion.scenario ||
                profileString(profile, "scenario") ||
                profileString(profile, "scene"),
              lore: profileString(profile, "lore"),
              memory: profileString(profile, "memory"),
              greeting:
                companion.greeting ||
                profileString(profile, "first_mes") ||
                profileString(profile, "greeting"),
              exampleDialogue:
              ...
              sliders: (() => {
                ...
                return {
                  jealousy:
                    typeof b.jealousyLevel === "number" ? b.jealousyLevel : 20,
                  dominance:
                    typeof b.dominanceLevel === "number"
                      ? b.dominanceLevel
                      : 20,
                  affection:
                    typeof b.affectionLevel === "number"
                      ? b.affectionLevel
                      : 60,
                  empathy:
                    typeof b.empathyLevel === "number" ? b.empathyLevel : 50,
                };
              })(),
            },
          };
