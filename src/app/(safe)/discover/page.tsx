...
export default async function DiscoverPage({
    ...
    return (
        <main className="space-y-6 text-zinc-100">
            <section className="rounded-[.5rem] border border-zinc-800 bg-[radial gradient(circle_at_top,rgba(168,85,247,0.18),transparent_75%)] p-5 sm:p-6">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2">
                    <a
                        href="/discover"
                        className={`inline-flex h-9 items-center rounded-lg border px-3 text-xs font-semibold transition ${!includeAdult
