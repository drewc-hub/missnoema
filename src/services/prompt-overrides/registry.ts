...
// ──────────────────────────────────────────────
import type { PromptOverrideKeyDef } from "@/components/types.js";
...
} from "@/components/registry/sprites.js";
import { GAME_NPC_PORTRAIT, GAME_BACKGROUND, GAME_SCENE_ILLUSTRATION } from "@/components/registry/game-assets.js";
import { CONVERSATION_SELFIE } from "@/components/registry/conversation.js";
...
export type { GameNpcPortraitCtx, GameBackgroundCtx, GameSceneIllustrationCtx } from "@/components/registry/game-assets.js";
export type { ConversationSelfieCtx } from "@/components/registry/conversation.js";
export type { PromptOverrideKeyDef, PromptVariable } from "@/components/types.js";
