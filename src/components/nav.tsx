        ...
        <header className="sticky top-0 z-20 border-b border-zinc-800 bg-slate-800 bg-opacity-50">
            <div className="mx-auto flex w-full max-w-6xl items-center px-4 py-3">
                ...
                <ul className="flex items-center space-x-1">
                    <li>
                        <NavLink href="/(safe)/companions" label="Companions" />
                    </li>
                    <li>
                        <NavLink href="/(safe)/companions/new" label="Create" />
                    </li>
                    <li>
                    ...
                    <li>
                        <NavLink href="/(safe)/chat/[id]" label="Chat" />
                    </li>
                    <li>
                        <NavLink href="/account/billing" label="app/(safe)Subscriptions" />
                    </li>
                </ul>
