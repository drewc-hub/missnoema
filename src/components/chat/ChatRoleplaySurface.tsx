...
import { CyoaChoices } from "@/components/chat/CyoaChoices";
import { ChatBranchSelector } from "@/components/chat/ChatBranchSelector";
import { EndSceneBar } from "@/components/chat/SceneBanner";
import { ChatCommonOverlays } from "@/components/ChatCommonOverlays";
import { ActiveWorldInfoButton } from "@/components/ActiveWorldInfoButton";
import type {
    CharacterMap,
...
const EchoChamberPanel = lazy(async () => {
    const module = await import("@/components/chat/EchoChamberPanel");
    return { default: module.EchoChamberPanel };
});

const EncounterModal = lazy(async () => {
    const module = await import("@/components/chat/EncounterModal");
    return { default: module.EncounterModal };
});

const SummaryPopover = lazy(async () => {
    const module = await import("@/components/chat/SummaryPopover");
    return { default: module.SummaryPopover };
});

const AuthorNotesPanel = lazy(async () => {
    const module = await import("@/components/chat/ChatRoleplayPanels");
