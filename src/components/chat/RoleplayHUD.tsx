...
const RoleplayHUDActionsMenu = lazy(async () =>
  import("@/components/chat/RoleplayHUDActionsMenu").then((module) => ({ default: module.RoleplayHUDActionsMenu })),
);
const CombinedPlayerPanel = lazy(async () =>
  import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.CombinedPlayerPanel })),
);
const PersonaStatsPanel = lazy(async () =>
  import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.PersonaStatsPanel })),
);
const CharactersPanel = lazy(async () =>
  import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.CharactersPanel })),
);
const InventoryPanel = lazy(async () =>
  import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.InventoryPanel })),
);
const QuestsPanel = lazy(async () => import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.QuestsPanel })));
const CustomTrackerPanel = lazy(async () =>
  import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.CustomTrackerPanel })),
);
const CombinedWorldPanel = lazy(async () =>
  import("@/components/chat/RoleplayHUDPanels").then((module) => ({ default: module.CombinedWorldPanel })),
);
