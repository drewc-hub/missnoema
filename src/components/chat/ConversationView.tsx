...
import { SceneBanner, EndSceneBar } from "@/components/SceneBanner";
import { ChatBranchSelector } from "@/components/ChatBranchSelector";
import { ActiveWorldInfoButton, ActiveWorldInfoModal } from "@/components/ActiveWorldInfoButton";
...
import type { CharacterMap, MessageSelectionToggle, PersonaInfo } from "@/components/chat/chat-area.types";
import type { Message } from "@marinara-engine/shared";

const ConversationAutonomousEffects = lazy(async () => {
  const module = await import("@/components/chat/ConversationAutonomousEffects");
