...
import { mirrorSpritePlacements, normalizeSpritePlacements } from "@/components/chat/sprite-placement";
import type { CharacterMap, MessageSelectionToggle, MessageWithSwipes, PeekPromptData } from "@/components/chat/chat-area.types";
import { RecentChats } from "@/components/chat/RecentChats";
import { HomeFaq } from "@/components/chat/HomeFaq";
import { NewChatConnectionGate } from "@/components/chat/NewChatConnectionGate";
import { ChatCommonOverlays } from "@/components/chat/ChatCommonOverlays";
...
const ChatConversationSurface = lazy(async () => {
    const module = await import("@/components/chat/ChatConversationSurface");
    return { default: module.ChatConversationSurface };
});

const ChatRoleplaySurface = lazy(async () => {
    const module = await import("@/components/chat/ChatRoleplaySurface");
    return { default: module.ChatRoleplaySurface };
});

const GameSurface = lazy(async () => {
    const module = await import("@/components/game/GameSurface");
