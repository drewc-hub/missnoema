...
import type { AgentData } from "@/components/modals/EditAgentModal";

const CreateCharacterModal = lazy(() =>
  import("@/components/modals/CreateCharacterModal").then((module) => ({ default: module.CreateCharacterModal })),
);
const ImportCharacterModal = lazy(() =>
  import("@/components/modals/ImportCharacterModal").then((module) => ({ default: module.ImportCharacterModal })),
);
const CharacterMakerModal = lazy(() =>
  import("@/components/modals/CharacterMakerModal").then((module) => ({ default: module.CharacterMakerModal })),
);
const CreateLorebookModal = lazy(() =>
  import("@/components/modals/CreateLorebookModal").then((module) => ({ default: module.CreateLorebookModal })),
);
const ImportLorebookModal = lazy(() =>
  import("@/components/modals/ImportLorebookModal").then((module) => ({ default: module.ImportLorebookModal })),
);
const LorebookMakerModal = lazy(() =>
  import("@/components/modals/LorebookMakerModal").then((module) => ({ default: module.LorebookMakerModal })),
);
const CreatePresetModal = lazy(() =>
  import("@/components/modals/CreatePresetModal").then((module) => ({ default: module.CreatePresetModal })),
);
const ImportPresetModal = lazy(() =>
  import("@/components/modals/ImportPresetModal").then((module) => ({ default: module.ImportPresetModal })),
);
const EditAgentModal = lazy(() =>
  import("@/components/modals/EditAgentModal").then((module) => ({ default: module.EditAgentModal })),
);
const STBulkImportModal = lazy(() =>
  import("@/components/modals/STBulkImportModal").then((module) => ({ default: module.STBulkImportModal })),
);
const ImportPersonaModal = lazy(() =>
  import("@/components/modals/ImportPersonaModal").then((module) => ({ default: module.ImportPersonaModal })),
);
const PersonaMakerModal = lazy(() =>
  import("@/components/modals/PersonaMakerModal").then((module) => ({ default: module.PersonaMakerModal })),
);
const CreateConnectionModal = lazy(() =>
  import("@/components/modals/CreateConnectionModal").then((module) => ({ default: module.CreateConnectionModal })),
);
const CreatePersonaModal = lazy(() =>
  import("@/components/modals/CreatePersonaModal").then((module) => ({ default: module.CreatePersonaModal })),
);
const CharacterCardUpdateModal = lazy(() =>
  import("@/components/modals/CharacterCardUpdateModal").then((module) => ({ default: module.CharacterCardUpdateModal })),
);
