...
import { SpotifyMobileWidget } from "@/components/spotify/SpotifyMiniPlayer";
import { ChatNotificationBubbles } from "@/components/chat/ChatNotificationBubbles";
import {
...
const ChatArea = lazy(() => import("@/components/chat/ChatArea").then((module) => ({ default: module.ChatArea })));
const CharacterEditor = lazy(() =>
  import("@/components/characters/CharacterEditor").then((module) => ({ default: module.CharacterEditor })),
);
const CharacterLibraryView = lazy(() =>
  import("@/components/characters/CharacterLibraryView").then((module) => ({ default: module.CharacterLibraryView })),
);
const LorebookEditor = lazy(() =>
  import("@/components/lorebooks/LorebookEditor").then((module) => ({ default: module.LorebookEditor })),
);
const PresetEditor = lazy(() => import("@/components/presets/PresetEditor").then((module) => ({ default: module.PresetEditor })));
const ConnectionEditor = lazy(() =>
  import("@/components/connections/ConnectionEditor").then((module) => ({ default: module.ConnectionEditor })),
);
const AgentEditor = lazy(() => import("@/components/agents/AgentEditor").then((module) => ({ default: module.AgentEditor })));
const ToolEditor = lazy(() => import("@/components/agents/ToolEditor").then((module) => ({ default: module.ToolEditor })));
const PersonaEditor = lazy(() =>
  import("@/components/personas/PersonaEditor").then((module) => ({ default: module.PersonaEditor })),
);
const RegexScriptEditor = lazy(() =>
  import("@/components/agents/RegexScriptEditor").then((module) => ({ default: module.RegexScriptEditor })),
);
const BotBrowserView = lazy(() =>
  import("@/components/bot-browser/BotBrowserView").then((module) => ({ default: module.BotBrowserView })),
);
const GameAssetsBrowserView = lazy(() =>
  import("@/components/game-assets/GameAssetsBrowserView").then((module) => ({ default: module.GameAssetsBrowserView })),
);
const RightPanel = lazy(() => import("@/components/layout/RightPanel").then((module) => ({ default: module.RightPanel })));
const TrackerDataSidebar = lazy(() =>
  import("@/components/layout/TrackerDataSidebar").then((module) => ({ default: module.TrackerDataSidebar })),
);
const OnboardingTutorial = lazy(() =>
  import("@/components/onboarding/OnboardingTutorial").then((module) => ({ default: module.OnboardingTutorial })),
);
