...
const CharactersPanel = lazy(() =>
  import("@/components/panels/CharactersPanel").then((module) => ({ default: module.CharactersPanel })),
);
const LorebooksPanel = lazy(() =>
  import("@/components/panels/LorebooksPanel").then((module) => ({ default: module.LorebooksPanel })),
);
const PresetsPanel = lazy(() => import("@/components/panels/PresetsPanel").then((module) => ({ default: module.PresetsPanel })));
const ConnectionsPanel = lazy(() =>
  import("@/components/panels/ConnectionsPanel").then((module) => ({ default: module.ConnectionsPanel })),
);
const AgentsPanel = lazy(() => import("@/components/panels/AgentsPanel").then((module) => ({ default: module.AgentsPanel })));
const PersonasPanel = lazy(() =>
  import("@/components/panels/PersonasPanel").then((module) => ({ default: module.PersonasPanel })),
);
const SettingsPanel = lazy(() =>
  import("@/components/panels/SettingsPanel").then((module) => ({ default: module.SettingsPanel })),
);
const BotBrowserPanel = lazy(() =>
  import("@/components/panels/BotBrowserPanel").then((module) => ({ default: module.BotBrowserPanel })),
);
