...
const NAV_ITEMS: NavItem[] = [
    { href: "/discover", icon: <Compass className="h-5 w-5" />, label: "Discover" },
    { href: "/companions", icon: <BookOpen className="h-5 w-5" />, label: "Companions" },
    { href: "/companions/new", icon: <Wand2 className="h-5 w-5" />, label: "Create" },
    { href: "/chat", icon: <MessageSquare className="h-5 w-5" />, label: "Chat" },
    { href: "/worlds", icon: <Globe className="h-5 w-5" />, label: "Worlds" },
    { href: "/marketplace", icon: <ShoppingBag className="h-5 w-5" />, label: "Market" },
    { href: "/tavern", icon: <CastleIcon className="h-5 w-5" />, label: "Tavern" },
    { href: "/adult", icon: <Flame className="h-5 w-5" />, label: "18+", accent: "text-rose-400" },
    { href: "/rpg", icon: <MessageSquarePlusIcon className="h-5 w-5" />, label: "RP & Chat", accent: "text-rose-400" },
];
        ...
        `}
            ...
            >
                ...
                <div className="flex items-center gap-3 px-3 py-5 border-b border-white/[0.06]">
                    <a href="/" className="shrink-0 flex items-center justify-center w-[46px] h-[46px] rounded-xl bg-white/5">
            ...
            `}
                ...
                <nav className="flex flex-col gap-1 p-2 flex-1 overflow-y-auto">
                    {NAV_ITEMS.map((item) => (
                        <SidebarItem key={item.href} item={item} expanded={sidebarExpanded} />
                    ))}
                </nav>
