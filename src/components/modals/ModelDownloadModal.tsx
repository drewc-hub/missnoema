                ...
                <div className="rounded-xl border border-[var(--border)] bg-[var(--card)]/50 p-3">
                    ...
                    {showRuntimeSettings && (
                        <div className="mt-4 flex flex-col gap-4 rounded-xl border border-[var(--border)]/80 bg-[var(--secondary)]/40 p-4">
                            ...
                            {testMessageResult && (
                                <div
                                    className={`rounded-xl border p-4 ${testMessageResult.success
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            {curatedModels.map((model) => (
                                <label
                                    ...
                                    className={`flex cursor-pointer items-center gap-3 rounded-xl border p-3 transition-colors ${selectedQuant === model.quantization
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        className={`h-4 w-4 shrink-0 rounded-full border-2 transition-colors ${selectedQuant === model.quantization
