...
import { ActiveWorldInfoButton, ActiveWorldInfoModal } from "@/components/chat/ActiveWorldInfoButton";
import type {
  PartyDialogueLine,
  CombatSummary,
  GameMap,
...
import { GameNarration, formatNarration } from "@/components/game/GameNarration";
import { GameInput } from "@/components/game/GameInput";
import { GameMapPanel, MobileMapButton } from "@/components/game/GameMap";
import { GamePartyBar } from "@/components/game/GamePartyBar";
...
import { GameDiceResult } from "@/components/game/GameDiceResult";
import { GameSkillCheckResult } from "@/components/game/GameSkillCheckResult";
import { GameElementReaction } from "@/components/game/GameElementReaction";
import { GameTravelView } from "@/components/game/GameTravelView";
import { GameSessionHistory, type CurrentSessionSecrets } from "@/components/game/GameSessionHistory";
import { GameTransitionManager } from "@/components/game/GameTransitionManager";
import { GameChoiceCards } from "@/components/game/GameChoiceCards";
import { GameQteOverlay } from "@/components/game/GameQteOverlay";
import { GameJournal } from "@/components/game/GameJournal";
import { GameJsonRepairModal } from "@/components/game/GameJsonRepairModal";
import {
  GameImagePromptReviewModal,
  type GameImagePromptOverride,
  type GameImagePromptReviewItem,
} from "@/components/game/GameImagePromptReviewModal";
import { GameTutorial } from "@/components/game/GameTutorial";
import { DirectionEngine } from "@/components/game/DirectionEngine";
import { GameWidgetPanel, GameWidgetSessionPrepModal, MobileWidgetPanel } from "@/components/game/GameWidgetPanel";
import { WeatherEffects } from "@/components/chat/WeatherEffects";
import { GameInventory } from "@/components/game/GameInventory";
import { GameReadableDisplay } from "@/components/game/GameReadableDisplay";
import { ChatGalleryDrawer } from "@/components/chat/ChatGalleryDrawer";
...
const SpriteOverlay = lazy(async () => {
  const module = await import("@/components/chat/SpriteOverlay");
  return { default: module.SpriteOverlay };
});

const GameCombatUI = lazy(async () => {
  const module = await import("@/components/game/GameCombatUI");
