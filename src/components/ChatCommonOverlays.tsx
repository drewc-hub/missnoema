...
import { PinnedImageOverlay } from "@/components/chat/PinnedImageOverlay";
import type { PeekPromptData } from "@/components/chat/chat-area.types";

const ChatSettingsDrawer = lazy(async () => {
    const module = await import("@/components/chat/ChatSettingsDrawer");
    return { default: module.ChatSettingsDrawer };
});

const ChatFilesDrawer = lazy(async () => {
    const module = await import("@/components/chat/ChatFilesDrawer");
    return { default: module.ChatFilesDrawer };
});

const ChatGalleryDrawer = lazy(async () => {
    const module = await import("@/components/chat/ChatGalleryDrawer");
    return { default: module.ChatGalleryDrawer };
});

const ChatSetupWizard = lazy(async () => {
    const module = await import("@/components/chat/ChatSetupWizard");
    return { default: module.ChatSetupWizard };
});

const PeekPromptModal = lazy(async () => {
    const module = await import("@/components/chat/PeekPromptModal");
