// scripts/generate-companions.mjs
// Run: node scripts/generate-companions.mjs
...
function makeBehaviorMeta(_, sliderBase) {
...
function makeCompanion(index) {
    ...
    const name = makeName();
    const slug = makeUniqueSlug(`${name} ${template.archetype}`, usedSlugs);
...
console.log("export const companions = [");
