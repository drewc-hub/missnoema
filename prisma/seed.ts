...
function normalizedProfile(c: SeedCompanion) {
  ...
  return {
    ...
    behaviorMeta: {
      voiceStyle: "",
      speechPattern: "warm, conversational, and emotionally responsive",
      emojiUsage: "light and natural",
      attachmentStyle: "secure",
      temperament: traits.includes("silly") ? "playful" : "gentle",
      traumaProfile: "",
      humorStyle: traits.includes("witty") || traits.includes("silly") ? "playful banter" : "soft humor",
      jealousyLevel: 10,
      dominanceLevel: traits.includes("confident") || traits.includes("protective") ? 45 : 25,
      affectionLevel: 72,
    },
    nsfwPreferenceTags: [],
    aiPersonalityPrompt: "",
