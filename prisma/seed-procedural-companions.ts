...
async function main() {
    const safeCount = Number(process.env.SEED_SAFE_COUNT ?? "0");
    ...
    const labelCycle: Array<"MEN" | "WOMEN" | "COUPLES" | "NB" | "TRANS WOMAN" | "TRANS MAN" | "GAY MAN" | "BISEXUAL MAN" | "LESBIAN" | "BESEXUAL WOMAN" | "PANSEXUAL"> = [
    ];
  ];
